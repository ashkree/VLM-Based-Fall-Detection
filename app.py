...
class FallDetection:
    ...
    def __init__(self):
        ...
        self.detector_options = ["Qwen 2.5 VL", "GPT-4 Vision", "Gemini 1.5 Flash", "Claude 3.5 Sonnet"]
        self.selected_detector = "Qwen 2.5 VL"
    ...
    def cleanup_memory(self):
        globals_to_clear = ["inputs", "outputs", "video_tensor", "frames"]
